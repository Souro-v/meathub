...
class _CheckoutScreenState extends State<CheckoutScreen> {
  static const double _platformFee =
      20; // this screen's own value — see conflict note from earlier
  ...
  Widget build(BuildContext context) {
    ...
    final deliveryFee = _selectedOption.fee;
    final total = subtotal + deliveryFee + _platformFee;
      ...
      body: SafeArea(
        child: Column(
          children: [
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    ...DummyData.deliveryOptions.map(
                      (o) => DeliveryOptionTile(
                        option: o,
            ...
            _buildBottomBar(context, total, defaultAddress),
          ],
        ),
      ),
    );
      ...
      child: Container(
        ...
        child: Row(
          children: const [
            ...
            Expanded(
              child: Text(
                AppStrings.deliverToCurrentLocation,
                style: TextStyle(
                  fontSize: 13.5,
                  fontWeight: FontWeight.w600,
                  color: AppColors.primary,
